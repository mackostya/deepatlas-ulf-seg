"""
Implementation of BaseModel in this work taken and modified from here
https://github.com/black0017/MedicalZooPytorch/blob/master/lib/medzoo/BaseModelClass.py
---
Implementation of BaseModel in MedicalZooPytorch taken and modified from here
...
class BaseModel(nn.Module, ABC):
    ...
    def save_checkpoint(self, directory, epoch, loss, optimizer=None, name=None):
        ...
        if name is None:
            name = "{}_{}_epoch.pth".format(os.path.basename(directory), "last")  # netD or netG
